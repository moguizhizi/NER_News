...
from bert_base.train.common import DEFAUL_LABELS
from bert_base.train.common import TRAIN_DATA
from bert_base.train.common import TEST_DATA
from bert_base.train.common import DEV_DATA
...
class NerProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        return self._create_example(
            self._read_data(os.path.join(data_dir, TRAIN_DATA)), "train_data"
        )

    def get_dev_examples(self, data_dir):
        return self._create_example(
            self._read_data(os.path.join(data_dir, DEV_DATA)), "dev_data"
        )

    def get_test_examples(self, data_dir):
        return self._create_example(
            self._read_data(os.path.join(data_dir, TEST_DATA)), "test_data")
...
def train(args):
    ...
    label_list = processor.get_labels(os.path.join(args.data_prepro_dir, LABELS_DATA))
